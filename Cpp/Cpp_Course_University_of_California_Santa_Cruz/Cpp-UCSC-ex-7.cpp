...
We use a lambda expression as an argument. We could also have used an old style named function (You should try this).
The function computes the circle of radius 1 centered at (0,0) in the plane.

The Monte Carlo method generates points at random in the unit square in the upper right quadrant.
The area of that square is of course 1.0. Now we can ratio of points that are below that function.  That ratio should approximate PI/4.
