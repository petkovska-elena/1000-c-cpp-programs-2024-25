...
class student {
  public: student(string nm, int id, double g, year x);
...
class grad_student: public student {
  public: grad_student(string nm, int id, double g, year x, support t, string d, string th);
  void print() const;
  protected: support s;
  string dept;
  string thesis;
...
grad_student::grad_student(
  ...
  support t, string d, string th): student(nm, id, g, x), s(t), dept(d), thesis(th) {}
